    ...
    >
      <div
        className={cn(
          ...
          'flex flex-col rounded-xl pl-5 py-5 pr-10 bg-background  h-full'
        )}
      >
        {landing ? (
        ...
        {landing ? (
          ...
          <Button
            className="rounded-full mt-5 bg-background-80 text-white hover:text-background-80 hover:bg-gradient-to-r hover:from-indigo-500  hover:via-purple-500 hover:to-pink-500"
